...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "Alakajam", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Alakajam";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Alakajam", null, { width: 640, height: 480 });

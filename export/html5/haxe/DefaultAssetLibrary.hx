...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/data/Lvl1t.oel", __ASSET__assets_data_lvl1t_oel);
		type.set ("assets/data/Lvl1t.oel", AssetType.TEXT);
		className.set ("assets/data/Maps.oep", __ASSET__assets_data_maps_oep);
		type.set ("assets/data/Maps.oep", AssetType.TEXT);
		...
		className.set ("assets/images/Flixoul.png", __ASSET__assets_images_flixoul_png);
		...
		className.set ("assets/images/tizles.png", __ASSET__assets_images_tizles_png);
		...
		type.set (id, AssetType.TEXT);
		id = "assets/data/Lvl1t.oel";
		path.set (id, id);
		
		type.set (id, AssetType.TEXT);
		id = "assets/data/Maps.oep";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_data_lvl1t_oel extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_data_maps_oep extends null { }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_flixoul_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_tizles_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:file("assets/data/Lvl1t.oel") #if display private #end class __ASSET__assets_data_lvl1t_oel extends lime.utils.Bytes {}
@:file("assets/data/Maps.oep") #if display private #end class __ASSET__assets_data_maps_oep extends lime.utils.Bytes {}
...
@:image("assets/images/Flixoul.png") #if display private #end class __ASSET__assets_images_flixoul_png extends lime.graphics.Image {}
...
@:image("assets/images/tizles.png") #if display private #end class __ASSET__assets_images_tizles_png extends lime.graphics.Image {}
...
@:image("assets/levels.png") #if display private #end class __ASSET__assets_levels_png extends lime.graphics.Image {}
